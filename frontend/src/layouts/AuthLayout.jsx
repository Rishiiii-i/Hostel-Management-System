export default function AuthLayout({ children }) {
  return <main className="auth-page">
    <section className="auth-showcase">
      <a className="auth-brand" href="#home"><span><svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M4 21h16M6 21V5l6-3 6 3v16M9 8h1M14 8h1M9 12h1M14 12h1M9 16h1M14 16h1" /></svg></span> homi</a>
      ...
      <p className="auth-footer">&copy; 2026 homi &middot; built for hostel life</p>
    </section>
