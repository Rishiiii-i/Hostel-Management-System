...
function App() {
  ...
  return <main id="home">
    <nav className="nav"><a className="brand" href="#home"><span><Icon name="building" /></span> Smart Hostel</a><div className="nav-links"><a href="#home">Home</a><a href="#features">Features</a><a href="#contact">Contacts</a></div><a className="login" href="#login">Sign In <b>→</b></a></nav>
    <section className="hero"><div><p className="label coral">A Better Way to Manage Your Hostel</p><h1>Simple hostel management<br />for <em>everyone</em></h1><p>Everything you need to manage rooms, students, fees, and requests in one place.</p><div className="hero-actions"><a className="button" href="#roles">Explore Smart Hostel <b>&rarr;</b></a><a href="#process" className="secondary">See How It Works</a></div></div><div className="hero-board"><div className="board-head"><span>Today's Hostel Updates</span><i>Live Overview</i></div><div className="board-numbers"><article><small>Students</small><b>328</b><span>+12 this week</span></article><article><small>Available Rooms</small><b>16</b><span>Ready to assign</span></article></div><div className="board-list"><p><b></b> Fee reminder sent <small>just now</small></p><p><b></b> Room 216 maintenance completed <small>12 min ago</small></p><p><b></b> 8 visitor requests waiting <small>24 min ago</small></p></div></div></section>
