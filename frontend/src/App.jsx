...
function App() {
  ...
  return <main id="home">
    <nav className="nav"><a className="brand" href="#home"><span><Icon name="building" /></span> homi</a><div className="nav-links"><a href="#home">home</a><a href="#features">features</a><a href="#contact">contacts</a></div><a className="login" href="#login">sign in <b>→</b></a></nav>
